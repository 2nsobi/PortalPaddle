...
/**
 ...
 @note Objective-C <pre> [[APDSdk sharedSdk] disableUserInfoForNetworkName:@"NETWORK_NAME"]; </pre>
 @note Swift <pre> APDSdk.sharedSdk().disableUserInfoForNetworkName("NETWORK_NAME") </pre>
